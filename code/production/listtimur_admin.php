                      ...
                      <tr class="even pointer">
                            <?php
                                ...
                                while($redudant_timur = mysqli_fetch_array($query)){
                                    ...
                                    echo "<td>";
                                    echo "<a href='formeditredudanttimur.php?id=".$redudant_timur['id']."'>Edit</a> | ";
                                    echo "<a href='deleteredudanttimur.php?id=".$redudant_timur['id']."'>Hapus</a>";
                                    echo "</td>";
                                    echo "</tr>";
                                    $i++;
                                }
                      ...
                      <tr class="even pointer">
                            <?php
                                ...
                                while($icon = mysqli_fetch_array($query)){
                                    ...
                                    echo "<td>";
                                    echo "<a href='formeditstandalonetimur.php?id=".$icon['id']."'>Edit</a> | ";
                                    echo "<a href='deletestandalonetimur.php?id=".$icon['id']."'>Hapus</a>";
                                    echo "</td>";
                                    echo "</tr>";
                                    $i++;
                                }
                            ...
                            <?php
                                ...
                                while($icon = mysqli_fetch_array($query)){
                                    ...
                                    echo "<td>".$icon['int_errortime']." Jam</td>";
									                  echo "<td>".$icon['keterangan']."</td>";
                                    echo "<td>";
                                    echo "<a href='formeditperipheraltimur.php?id=".$icon['id']."'>Edit</a> | ";
                                    echo "<a href='deleteperipheraltimur.php?id=".$icon['id']."'>Hapus</a>";
                                    echo "</td>";
                                    echo "</tr>";
                                    $i++;
                                }
