...
if (@$_COOKIE['sum_icon'] == NULL and @$_COOKIE['counticon']==NULL){
  $_COOKIE['sum_icon']=0;
  $_COOKIE['counticon']=0;
}
?>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="dashboard_graph">
                ...
                <div class="row x_title">
                  <div class="col-md-6">
                    <h3>GRAFIK ICON</h3>
                    <p>Note: Grafik <code> X:Tanggal pada bulan yang dipilih </code> dan <code>Y:Lama gangguan Icon (Jam)</code></p>
                  </div>
                  ...
                  <div class="form-group">
                        ...
                        <button  name="Monthpickicon" type="submit" class="pull-right btn btn-danger btn-md">Go</button>
                    </div>
                  </form>
                </div>
                ...
                <div class="col-md-3 col-sm-3 col-xs-12 bg-white">
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-6">
                    <div>
                      <p>Total ICON Bulanan <code> <?php echo $_COOKIE['counticon'] ?> </code></p>
                      <div class="">
                    ...
                    <div>
                      <p>Total Gangguan ICON Bulanan<code> <?php echo $_COOKIE['sum_icon'] ?></code> Jam</p>
                      <div class="">
                        <div class="progress progress_sm" style="width: 90%;">
