              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    $sql = "SELECT * FROM rekap_nodin WHERE id=$id";
                    $query = mysqli_query($db, $sql);
                    $nodin = mysqli_fetch_assoc($query);

                    ?>
                    <form action="writedatanodin.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">

                      <div class="form-group">
                        <input type="hidden" name="id" value="<?php echo $nodin['id'] ?>" />
                        <label class="control-label col-md-2" >Nama NODIN <span class="required">*</span>
                        </label>
                        <div class="col-md-5 col-sm-6 col-xs-12">
                          <textarea type="text"  class="form-control col-md-7 col-xs-12" name="nama"><?php echo $nodin['nama'] ?></textarea>
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class='input-group date col-md-5 col-sm-6 col-xs-12' id='myDatepicker2'>
                          <input type='text' class="form-control" name="tanggal_awal" value="<?php echo date('d.m.Y', strtotime($nodin['tanggal_awal'])); ?>" />
                      ...
                      <div class="form-group">
                        ...
                        <div class='input-group date  col-md-5 col-sm-6 col-xs-12 ' id='myDatepicker1'>
                          <input type='text' class="form-control" name="tanggal_akhir" value="<?php echo date('d.m.Y', strtotime($nodin['tanggal_akhir'])); ?>"/>
                          <span class="input-group-addon">
                             <span class="glyphicon glyphicon-calendar"></span>
                          </span>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div id="keterangan" class="btn-group" data-toggle="buttons">
                            ...
                            <label class="btn btn-primary" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                              <input type="radio" name="keterangan" value="belum" /> Belum
                            </label>
                          </div>
                        </div>
                      </div>
