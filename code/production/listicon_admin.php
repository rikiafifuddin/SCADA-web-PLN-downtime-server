          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Tabel <small>Rekap ICON</small></h2>
                  ...
                  <form action="exportIcNod.php" method="POST">
                       <div class="form-group">
                        ...
                        <div class='input-group date col-md-5 col-sm-6 col-xs-12' id='myDatepicker'>
                          <input type='text' class="form-control" name="exportDateicon" />
                          <span class="input-group-addon">
                             <span class="glyphicon glyphicon-calendar"></span>
                          </span>
                        </div>
                      </div>
                    <button name="export" type="submit" class="btn btn-danger btn-sm">Excel</button>
					          <button name="exportPDF" type="submit" class="btn btn-danger btn-sm">PDF</button>
                    </form>
					<table id="datatable" 
                  <div class="x_content">
                      ...
                      <thead>
                        <tr>
                          <th>ID</th>
                          <th>Gardu Induk</th>
                          <th>Tanggal dan Jam Gangguan</th>
                      ...
                      <tbody>
                          <tr class="even pointer">
                            <?php
                                $i=1;
                                $sql = "SELECT * FROM rekap_icon ORDER by id DESC";	
                                $query = mysqli_query($db, $sql);
								
                                while($icon = mysqli_fetch_array($query)){
                                    echo "<tr>";
                                    echo "<td>$i</td>";
                                    echo "<td>".$icon['gardu_induk']."</td>";
                                    echo "<td>".$icon['down_time']."</td>";
                                    echo "<td>".$icon['up_time']."</td>";
                                    echo "<td>".$icon['int_errortime']." Jam</td>";
									                  echo "<td>".$icon['keterangan']."</td>";
                                    echo "<td>";
                                    echo "<a href='formediticon.php?id=".$icon['id']."'>Edit</a> | ";
                                    echo "<a href='deleteicon.php?id=".$icon['id']."'>Hapus</a>";
                                    echo "</td>";
                                    echo "</tr>";
                                    $i++;
                                }
