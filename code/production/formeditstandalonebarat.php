          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>FORM EDIT STAND ALONE BARAT</h3>
              </div>
            </div>
            <div class="clearfix"></div>
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    $id = $_GET['id'];
                    $sql = "SELECT * FROM standalone_barat WHERE id=$id";
                    $query = mysqli_query($db, $sql);
                    $standalone_barat = mysqli_fetch_assoc($query);
                    ...
                    <form action="writedataSAbarat.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <input type="hidden" name="id" value="<?php echo $standalone_barat['id'] ?>" />
                        ...
                        <div class="col-md-5 col-sm-6 col-xs-12">
                          <select name="ServerName" class="form-control">
                            <option value="<?php echo $standalone_barat['peralatan'] ?>"><?php echo $standalone_barat['peralatan'] ?></option>
                      ...
                      <div class="form-group">
                        ...
                        <div class='input-group date col-md-5 col-sm-6 col-xs-12' id='myDatepicker'>
                          <input name="DownTime" type='text' class="form-control" value="<?php echo date('m/d/Y H:i:s', strtotime($standalone_barat['down_time'])) ?>"/>
                      ...
                      <div class="form-group">
                        ...
                        <div class='input-group date col-md-5 col-sm-6 col-xs-12' id='myDatepicker4'>
                          <input name="UpTime" type='text' class="form-control" value="<?php echo date('m/d/Y H:i:s', strtotime($standalone_barat['up_time'])) ?>"/>
                          <span class="input-group-addon">
                             <span class="glyphicon glyphicon-calendar"></span>
                          </span>
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-5 col-sm-6 col-xs-12">
                          <input name="keterangan" type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $standalone_barat['keterangan'] ?>">
                        </div>
                      </div>
