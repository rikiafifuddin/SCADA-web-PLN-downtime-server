...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO peripheral_timur (peralatan, down_time, up_time, errortime, int_errortime, keterangan) VALUE ('$ServerName', '$DownTime', '$UpTime', '$difft', '$int_errortime', '$keterangan')";
   ...
   header("location:index.php");
    ...
    $sqlupdate = "UPDATE peripheral_timur SET peralatan='$ServerName', down_time='$DownTime', up_time='$UpTime', errortime='$difft', int_errortime='$int_errortime', keterangan='$keterangan' WHERE id=$id";
